...
public class NoobTest {
	...
	public void testConstrutor() {
		try {
			...
			assertEquals(0.1, pabllo.getDesconto(), 0.05);
		} catch (Exception e) {
	...
	public void testCompraJogoComSaldo() {
		try {
			...
			assertEquals(56.009, pabllo.getSaldo(), 0.05);
	...
	public void testEquals() {
		try {
			...
			Usuario pablloXara = new Noob("Pabllo", "pabllo.alves");
			assertNotEquals(pabllo, pablloXara);

			Usuario fabiana = new Noob("Fabiana", "fabiana.alves");
